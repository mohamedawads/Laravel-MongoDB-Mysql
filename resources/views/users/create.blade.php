        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
					...
					<form action="{{ Request::segment(1) == 'mongodb' ? route('usersmongo.store') : route('usersmysql.store')}}" method="POST">
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-12 col-md-12">
								...
								<div class="form-group">
									...
									<input style="border-color: #ff0000;" type="text" name="age" class="form-control" placeholder="Age">
							...
							<div class="col-xs-12 col-sm-12 col-md-12">
								...
								<div class="form-group">
									...
									<input style="border-color: #ff0000;" type="text" name="mobile" class="form-control" placeholder="Mobile">
